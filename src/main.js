...
addButton.addEventListener("click", () =>  console.log("cliquei mano"))
...
expirationDateMasked.on("accept", () => updateExpirationNumber(expirationDateMasked.value))

function updateExpirationNumber(number){
